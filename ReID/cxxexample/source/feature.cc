...
Feature::Feature(const std::string& prototxt, const std::string& model_file) {
    std::cout<<"Loading: "<<prototxt<<std::endl;
    net_ = cv::dnn::readNetFromCaffe(prototxt, model_file);
